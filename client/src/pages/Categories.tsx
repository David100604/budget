...
const Categories: FC = () => {
    ...
    return (
        <>
            <div className="mt-10 p-4 rounded-mg bg-slate-800">
                <h1> Your categoryy list:</h1>
                <div className="mt-2 flex  flex-wrap items-center gap-2">
                    {categories.map((category, id) => (
                        <div key={id} className="group py-2 px-4 rounded-lg bg-blue-600 flex items-center relative gap-2">
                        {category.title}
